...
import com.assessment.quizebuilder.databinding.ItemPublisherQuizBinding
import com.assessment.quizebuilder.domain.model.QuizEntity
import dagger.hilt.android.AndroidEntryPoint

class PublisherQuizListAdapter :
    ListAdapter<QuizEntity, PublisherQuizListAdapter.QuizListViewHolder>(PublisherQuizDiffUtil()) {

    var onItemClick: ((String?) -> Unit) = {}
    var onShareItemClick: ((String?) -> Unit) = {}
    var onDeleteItemClick: ((String?) -> Unit) = {}
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuizListViewHolder {
        return QuizListViewHolder(
            ItemPublisherQuizBinding.inflate(
    ...
    inner class QuizListViewHolder(
        private val binding: ItemPublisherQuizBinding
        ...
        fun bind(item: QuizEntity) {
            ...
            binding.buttonShare.setOnClickListener {
                onShareItemClick.invoke(item.quizId)
            }
            binding.buttonDelete.setOnClickListener {
                onDeleteItemClick.invoke(item.quizId)
            }
        }
    }

    class PublisherQuizDiffUtil : DiffUtil.ItemCallback<QuizEntity>() {
